...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "14441c21-bd1b-4479-8869-0fb224301ca6",
...
const _lazy_s6uLtW = () => import('../routes/renderer.mjs');

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_s6uLtW, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_s6uLtW, lazy: true, middleware: false, method: undefined }
];
...
export { useRuntimeConfig as a, getResponseStatus as b, getQuery as c, defineRenderHandler as d, createError$1 as e, getRouteRules as f, getResponseStatusText as g, joinRelativeURL as j, parseQuery as p, toNodeListener as t, useNitroApp as u };
